import { ChevronLeft, Calendar, MapPin, Users, Mail, Phone } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="min-h-screen px-4 py-8">
        <div
          className="bg-white dark:bg-gray-800 rounded-xl max-w-5xl mx-auto"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Modal Header */}
          <div className="sticky top-0 bg-gradient-to-r from-[#063FA1] to-[#052d7a] text-white p-6 rounded-t-xl z-10">
            <button
              onClick={onClose}
              className="mb-4 inline-flex items-center gap-2 hover:text-yellow-300 transition-colors"
            >
          ...
          <div className="p-6 lg:p-8">
            ...
            {/* Event Overview */}
            <div className="mb-8">
              <h4 className="text-2xl font-bold text-[#063FA1] dark:text-yellow-400 mb-4">
                Event Overview
              </h4>
