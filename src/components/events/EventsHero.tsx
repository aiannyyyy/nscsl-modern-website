      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-8">
          ...
          <div className="flex justify-center gap-6 mb-8">
            <div className="bg-white/10 dark:bg-yellow-500/20 backdrop-blur-sm p-4 rounded-full animate-bounce">
              <Calendar className="w-8 h-8 text-white dark:text-yellow-400" />
            </div>
            ...
            <div className="bg-white/10 dark:bg-yellow-500/20 backdrop-blur-sm p-4 rounded-full animate-bounce delay-200">
              <Heart className="w-8 h-8 text-white dark:text-yellow-400" />
            </div>
          </div>
          ...
          <p className="text-xl text-white/90 dark:text-gray-300 max-w-2xl mx-auto">
            Join our mission to improve newborn health through community events and educational programs
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-6 mt-12">
          <div className="bg-white/10 dark:bg-gray-800/50 backdrop-blur-sm px-6 py-4 rounded-xl border border-white/20 dark:border-yellow-400/30 hover:scale-105 transition-transform">
            <div className="text-3xl font-bold text-white dark:text-yellow-400">100+</div>
            <div className="text-sm text-white/80 dark:text-gray-300">Events Held</div>
          </div>
          <div className="bg-white/10 dark:bg-gray-800/50 backdrop-blur-sm px-6 py-4 rounded-xl border border-white/20 dark:border-yellow-400/30 hover:scale-105 transition-transform">
            <div className="text-3xl font-bold text-white dark:text-yellow-400">5000+</div>
            <div className="text-sm text-white/80 dark:text-gray-300">Participants</div>
          </div>
          <div className="bg-white/10 dark:bg-gray-800/50 backdrop-blur-sm px-6 py-4 rounded-xl border border-white/20 dark:border-yellow-400/30 hover:scale-105 transition-transform">
            <div className="text-3xl font-bold text-white dark:text-yellow-400">5</div>
            <div className="text-sm text-white/80 dark:text-gray-300">Provinces</div>
          </div>
        </div>
      </div>
